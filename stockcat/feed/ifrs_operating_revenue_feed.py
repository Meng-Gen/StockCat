...
from stockcat.assembler.ifrs_operating_revenue_assembler import IfrsOperatingRevenueAssembler
from stockcat.common.string_utils import StringUtils
from stockcat.common.file_utils import FileUtils

import datetime

class IfrsOperatingRevenueFeed():
    ...
    def get(self):
        ...
        print self.__assemble()

    def __copy_url_to_file(self):
        print 'copy_url_to_file', self.url, self.filepath
    ...
    def __assemble(self):
        ...
        assembler = IfrsOperatingRevenueAssembler()
    ...
    def __build_filepath(self):
        return "./stockcat/data/ifrs_operating_revenue/%s_%s_%s.html" % (self.stock_symbol, self.year, self.month)
