...
from stockcat.spider.ifrs_operating_revenue_spider import IfrsOperatingRevenueSpider
from stockcat.spider.legacy_operating_revenue_spider import LegacyOperatingRevenueSpider
